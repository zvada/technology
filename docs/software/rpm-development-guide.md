...
The following directories may be generated by our build tool, [OSG-Build](SoftwareTeam.OSGBuildTools). They are not under revision control.
...
2.  The [OSG build tools](SoftwareTeam.OSGBuildTools) will take those files, create a source RPM, and submit it to our Koji build system
