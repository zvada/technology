...
The following directories may be generated by our build tool, [OSG-Build](osg-build-tools.md). They are not under revision control.
...
2.  The [OSG build tools](osg-build-tools.md) will take those files, create a source RPM, and submit it to our Koji build system
