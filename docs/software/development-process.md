...
3.  Use [osg-build](https://twiki.opensciencegrid.org/bin/view/SoftwareTeam/OSGBuildTools#osg_build) to perform a scratch build of the updated package
...
6.  Use [osg-build](https://twiki.opensciencegrid.org/bin/view/SoftwareTeam/OSGBuildTools#osg_build) to perform an official build of the updated package (which will go into the development repos)
...
3.  Use [osg-promote](https://twiki.opensciencegrid.org/bin/view/SoftwareTeam/OSGBuildTools#osg_promote) to promote the package(s) from development to testing
