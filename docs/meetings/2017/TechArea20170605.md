...
-   Purdue used OSG_WN_TMP configuration in osg-configure to set it to condor's scratch directory (execute directory?)
-   Utah renewed certificate, and is now working.
-   APEL update from ALICE usage.
