...
We have released [documentation](https://opensciencegrid.github.io/docs/data/load-balanced-gridftp.md)
...
- March 2017 (completed):
  Release [load balanced GridFTP](https://opensciencegrid.github.io/docs/data/load-balanced-gridftp.md)
  documentation
